  ...
  .container {
    ...
    .swiper {
      ...
      .slide {
        ...
        .the-date {
          @apply text-16px absolute right-21px bottom-12px;
          color: #E7E7F0;
          font-family: 'SB Sans Interface';
          opacity: 0.8;
        }
        .user {
          @apply flex flex-row items-center w-full max-w-290px absolute -top-50px -right-10px ;
          &::after {
      ...
      .card {
        @apply flex flex-col items-start h-398px w-548px pl-20px pt-50px relative;
        background: url('/images/sber/fifth-section/bg.png')center bottom/contain no-repeat;
        // background-color: red;
        &-title {
        ...
        &-description {
          @apply text-17px font-400 leading-17px text-left mt-8px;
          font-family: 'SB Sans Interface';
          color: #E7E7F0;
        }
        &-items {
          @apply flex flex-row items-start flex-wrap mt-31px;
          .item {
