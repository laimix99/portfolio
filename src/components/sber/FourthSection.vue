...
.fourth-section {
  ...
  .container {
    ...
    .content {
      @apply flex flex-col items-center w-560px mb-44px;
      border: 2px solid #2B9A4A;
      ...
      h1 {
        @apply text-32px font-600 text-white py-15px w-full; 
        font-family: 'SB Sans Interface';
        border-bottom: 1.5px solid #2B9A4A ;
      }
    }
  }
}
