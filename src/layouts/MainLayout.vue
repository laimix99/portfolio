<script setup>
const links = [
  { path: '/test', name: 'Тестовые задания ', img: '/images/test.jpg', subtitle: '' },
  { path: '/calculator', name: 'Calculator',img: '/images/calculator.jpg', subtitle: 'Here you can see different versions of Calculator' },
  { path: '/todo', name: 'Todo', img: '/images/todo.jpg', subtitle: 'Here you can see different versions of ToDo' },
  { path: '/movies', name: 'Movies', img: '/images/movies.jpg', subtitle: 'Application for the movies and series search' },
  { path: '/photographer', name: 'Photographer', img: '/images/photographer.jpg', subtitle: 'Photographer website' },
  { path: '/deli', name: 'Deli', img: '/images/deli.webp', subtitle: 'Delimobile website' },
  ...
  { path: '/trello', name: 'Trello', img: '/images/trello.jpg', subtitle: 'trello website' },
  { path: '/commissioner', name: 'Сommissioner', img: '/images/commissioner.jpg', subtitle: 'Сommissioner website' },
  ...
  { path: '/chat', name: 'Chat', img: '', subtitle: '' },
  // { path: '/', name: 'My app' },
